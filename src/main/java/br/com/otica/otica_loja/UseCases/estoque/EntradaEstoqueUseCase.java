...
public class EntradaEstoqueUseCase {
    ...
    /**
     * Registra uma entrada de estoque para uma variante.
     */
    public EstoqueMovimentacao registrarEntrada(UUID varianteId, Integer quantidade, UUID usuarioId, String observacao) {
        // 1. Buscar variante
