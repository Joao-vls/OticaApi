...
public class AtualizarBannerEditorialUseCase {
    ...
    public BannerEditorial executar(
        ...
        BannerEditorial banner = bannerEditorialRepository.findByIdentificador(identificador)
                .orElseThrow(() -> new EntityNotFoundException("Banner não encontrado com o identificador: " + identificador));
